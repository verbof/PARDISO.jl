...
function checkPARDISO{Tnzval}(pardiso::ParDiSO, A::SparsePardisoCSR{Tnzval})
    ...
    if Tnzval == Float64
        ccall( (:pardiso_checkmatrix_, "/Users/fabio/.julia/v0.4/PARDISO/lib/PARDISO"), Void,
    ...
    elseif Tnzval == Complex128
        ccall( (:pardiso_checkmatrix_z_, "/Users/fabio/.julia/v0.4/PARDISO/lib/PARDISO"), Void,
